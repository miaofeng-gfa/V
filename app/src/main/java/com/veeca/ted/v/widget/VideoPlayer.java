...
//            Log.i(TAG,"percent:"+percent);
    ...
    private VideoPlayerItemInfo.DataBean dataBean;

    public void setPlayData(VideoPlayerItemInfo.DataBean dataBean) {
        this.dataBean = dataBean;
        mediaController.setTvTitle(dataBean.getTitle());
        mediaController.setVideoName(dataBean.getNickName());
        mediaController.setVideoProfit("创意分红：" + dataBean.getVideoPriceSum() + "元");
    }

    private void itemPlay(int vid) {
        service.getplay(vid)
