package com.veeca.ted.v.widget;
...
public class SuperCircleView extends View {
    ...
    //设置渐变颜色
    public void setMColors(String s1, String s2, String s3){
        color[0] = Color.parseColor(s1);
        color[1] = Color.parseColor(s2);
        color[2] = Color.parseColor(s3);
    }
    ...
    public SuperCircleView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMaxCircleColor = a.getColor(R.styleable.SuperCircleView_max_circle_color, context.getResources().getColor(R.color.white));
        mRingNormalColor = a.getColor(R.styleable.SuperCircleView_ring_normal_color, context.getResources().getColor(R.color.bg_color));
...
//        color[2] = Color.parseColor("#8EE484");
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(mViewCenterX, mViewCenterY, mMinRadio + mRingWidth + 5, mPaint);
